...
print("Loading merged SFT Tower terms model...")
...
for BETA in BETAS:
    OUTPUT_DIR = f"{MODEL_PATH}/DPO_TowerInstruct_terms_beta{BETA}"
    print(f"\n{'='*50}")
    print(f"  Starting DPO terms Tower training — beta={BETA}")
    print(f"{'='*50}")
