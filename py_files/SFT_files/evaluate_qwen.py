...
OUT_DIR = f"{MODELS_DIR}/SFT_Qwen3_final/eval_results"
SCORES_FILE = f"{OUT_DIR}/val_scores_full.json"

CHECKPOINTS = {
    "checkpoint-625":  f"{MODELS_DIR}/SFT_Qwen3_final/checkpoint-625",
    "checkpoint-1250": f"{MODELS_DIR}/SFT_Qwen3_final/checkpoint-1250",
    "checkpoint-1875": f"{MODELS_DIR}/SFT_Qwen3_final/checkpoint-1875",
}
