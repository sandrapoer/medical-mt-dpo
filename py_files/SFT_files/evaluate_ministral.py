...
OUT_DIR = f"{MODELS_DIR}/SFT_Ministral_final/eval_results"
SCORES_FILE = f"{OUT_DIR}/val_scores_full.json"

CHECKPOINTS = {
    "checkpoint-625": f"{MODELS_DIR}/SFT_Ministral_final/checkpoint-625",
    "checkpoint-1250": f"{MODELS_DIR}/SFT_Ministral_final/checkpoint-1250",
    "checkpoint-1875": f"{MODELS_DIR}/SFT_Ministral_final/checkpoint-1875",
}
...
def load_val_data(path: str):
    ...
    with open(path, "r", encoding="utf-8") as f:
        for line in f:
            ...
            # Ministral only needs [/INST]
            prompt = f"<s>[INST]{user_msg['content']}[/INST]"
